...
if(isset($_POST['add']))
{
	...
	move_uploaded_file($temp_name5,"images/property/$aimage5");
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/property/<?php echo $row['18'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/property/<?php echo $row['20'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/property/<?php echo $row['22'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/property/<?php echo $row['26'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="images/property/<?php echo $row['28'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
											</div>
											<div class="col-xl-6">
