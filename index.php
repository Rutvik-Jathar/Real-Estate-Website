...
<div id="page-wrapper">
    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We are represent either party and help them achieve a purchase or sale with the best possible terms.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Showing best property for user in their bugget.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Properties list by users requirements.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Consult a financial advisor who will be able to guide you on the basis of your financial portfolio and help you build it further.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/back1.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our knowledge, experience, expertise and resources set us apart allowing us to achieve results that don’t just meet, but exceed our clients’ expectations. It is our commitment to provide you with exceptional service from a team of highly skilled, uniquely talented individuals with high integrity, extensive professional knowledge and experience, far‐reaching connections and excellence in home marketing.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Buying Strategies</h5>
										<p>We use modern technology along with our market knowledge, unsurpassed negotiation and sales skills, professional experience and collaboration to assist you in identifying your desired property and securing the best price and terms, while protecting your interests..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Communication And Responsiveness</h5>
										<p>We are known for our proven ability to maintain open communication around the clock and a high level of responsiveness to our clients throughout the transaction process and beyond..</p>
									</div>
                                </li>
                            </ul>
                        </div>
